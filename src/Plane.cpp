...
void Plane::CheckAllCollisions()
{
	...
	cout << endl << "Time checking collisions through bruteforce: " << glfwGetTime() - start - timeSpentColoring << endl;
	genCirclesBuffers();
}
...
void Plane::CheckHashCollisions()
{
	...
	cout << endl << "Time checking collisions through hash table: " << glfwGetTime() - start - timeSpentColoring << endl;
	genCirclesBuffers();
}
...
void Plane::GenerateHashTable()
{
	...
	cout << endl << "Time generating hash table: " << glfwGetTime() - start << endl;
}
...
void Plane::processInput(double deltaTime)
{
	...
	{
		numCircles += 50;
		cout << "Total circles: " << numCircles << endl;
		genCircles();
		genCirclesBuffers();
		return;
	}
	...
	{
		curveSteps += 50.0f;
		cout << "Total curve segments: " << curveSteps << endl;
		genCurve();
		genCurveBuffers();
		return;
	}
...
{
	cout << endl << "Initialized parameters" << endl;

	cout << endl << "Circle parameters" << endl;
	cout << "Radius: " << size << endl;
	cout << "Resolution: " << circleSteps << endl;
	cout << "Total circles: " << numCircles << endl;

	cout << endl << "Bezier parameters" << endl;
	cout << "Control Points: " << numControlPoints << endl;
	cout << "Segments: " << curveSteps << endl;
